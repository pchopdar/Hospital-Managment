...
<html lang="en">
<head>
    <title>Usha-Kiran Hospital</title>
                        ...
                        <div class="site-branding d-flex align-items-center">
                           ...
                           <div id="apDiv1">
                             <table width="200" border="0">
                               <tr>
                                 <td><a href="login.html" method="get">Login</a></td>
                                 <td><a href="registration.html" method="get">Registration</a></td>
                               </tr>
                             </table>
                           </div>
                           <a class="d-block" href="index.html" rel="home">    </a>
                  </div>
                        <!-- .site-branding -->
